...
import type { GetGuildLeaderboardData, GetGuildLeaderboardResponse, GetGuildMembersData, GetGuildMembersResponse, GetGuildDetailsData, GetGuildDetailsResponse, SearchMarketListingsData, SearchMarketListingsResponse } from './types.gen';
 ...
 * @throws ApiError
 */
export const getGuildLeaderboard = (data: GetGuildLeaderboardData): CancelablePromise<GetGuildLeaderboardResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getGuildMembers = (data: GetGuildMembersData): CancelablePromise<GetGuildMembersResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getGuildDetails = (data: GetGuildDetailsData): CancelablePromise<GetGuildDetailsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const searchMarketListings = (data: SearchMarketListingsData): CancelablePromise<SearchMarketListingsResponse> => { return __request(OpenAPI, {
    method: 'POST',
