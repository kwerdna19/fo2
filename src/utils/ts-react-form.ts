/* eslint-disable */
// copied for now from https://github.com/iway1/react-ts-form/blob/main/src/createFieldSchema.tsx
// due to server/client bug (createContext cant be used on server - despite not being used in the function)

import { type RTFSupportedZodTypes } from "@ts-react/form";
import { type z, type ZodBranded } from "zod";
 ...
 * @internal
 */
export interface HiddenProperties {
